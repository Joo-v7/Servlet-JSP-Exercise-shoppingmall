...
<div class="container">
    ...
    <div id="editInfo" class="content active">
        ...
        <div style="margin: auto; width:600px;">
            <div class="p-2">
                <form method="post" action="/mypage/unsubscribe/unsubscribeAction.do">

                    <h1 class="h3 mb-3 fw-normal">아이디와 비밀번호를 입력하세요.</h1>
                    ...
                    <button class="w-100 btn btn-lg btn-primary mt-3" type="submit">회원 탈퇴</button>
